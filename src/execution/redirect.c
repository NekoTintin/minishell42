...
/*   Updated: 2025/06/20 17:57:50 by qupollet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	exec_redirect_input(t_cmd *cmd, t_exec *exec)
{
	t_redirect	*cur;
	int			code;
...
int	ft_redirects(t_cmd *cmd, int p1, int p2, t_exec *exec)
{
	...
	{
		return_code = exec_redirect_input(cmd, exec);
		if (return_code != 0)
			return (return_code);
	}
